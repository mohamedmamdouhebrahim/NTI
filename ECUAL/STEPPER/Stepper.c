...
Stepper Steppers[NumberOfStepperMotors]={
	{DIO_PORTB,DIO_PIN0,DIO_PORTB,DIO_PIN1,DIO_PORTB,DIO_PIN2,DIO_PORTB,DIO_PIN3,4096,0},
	{DIO_PORTB,DIO_PIN4,DIO_PORTB,DIO_PIN5,DIO_PORTB,DIO_PIN6,DIO_PORTB,DIO_PIN7,4096,0}
};
#define StepDelay 5
/**********************************************************************************************************************
 *  LOCAL DATA 
